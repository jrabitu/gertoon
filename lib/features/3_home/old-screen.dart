...
// The main build method for the HomeScreen
  ...
  Widget build(BuildContext context) {
    ...
    final List<Comic> mainListComics = mockComics.where((comic) {
      if (_selectedFeed == 'Comic') return comic.genres.contains('Romance'); // Example logic
      if (_selectedFeed == 'Manga') return comic.genres.contains('Action'); // Example logic
      if (_selectedFeed == 'Novel') return comic.genres.contains('Fantasy'); // Example logic
      return true;
    }).toList();
    return Scaffold(
      // appBar: AppBar(
      ...
      body: CustomScrollView(
       ...
       //section 2: silver comic section widget
          SliverComicSection(
